        ...
        @foreach($aboutAretists as $aboutAretists)
            ...
            <td><img src="{{ $aboutAretists->image_ar }}" style="width:120px;height:100px"></td>
                <td>
                    ...
                    <div class='btn-group'>
                        <a href="{{ route('aboutAretists.show', [$aboutAretists->id]) }}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                        <a href="{{ route('aboutAretists.edit', [$aboutAretists->id]) }}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
