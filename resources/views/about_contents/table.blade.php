        ...
        @foreach($aboutContents as $aboutContent)
            ...
            <td>{{ $aboutContent->body2_ar }}</td>
                <td>
                    ...
                    <div class='btn-group'>
                        <a href="{{ route('aboutContents.show', [$aboutContent->id]) }}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                        <a href="{{ route('aboutContents.edit', [$aboutContent->id]) }}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
