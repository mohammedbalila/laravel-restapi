        ...
        >
          ...
          <swiper class="agile_swap swap_sm">
            <swiper-slide
              ...
              ref="myActive"
              @click.native="addActive(palettesArtist.id,index)"
            ...
            >
              ...
              <div class="content" :class="{ 'active': index == 0 }">
                ...
                <h6>
                  ...
                  <span class="price px-1">${{palettesArtist.M_price}}</span>
                </h6>
          ...
          <div class="wrapper swap_lg">
            <div class="row d-flex justify-content-center" style="width:100%">
              <div
                class="details col-lg-3 col-sm-4"
                :class="{ 'active': index == 0 }"
                ref="myActive"
                v-for="(palettesArtist , index) in artist.artist_palettes"
                @click="addActive(palettesArtist.id,index)"
                :key="palettesArtist.id"
              >
        ...
        <div class="col-lg-7" style="margin-top:70px">
          <div class="row">
            <div class="col-md-6 col-sm-12">
              <img :src="minPalettesActive.img" style="height:355px; width:355px" alt="..." />
            </div>
            <div class="col-md-6 col-sm-12" v-for="minPalette in minPalettes" :key="minPalette.id">
              <img :src="minPalette.img" style="height:355px; width:355px" alt="..." />
            </div>
          </div>
        </div>
        <div class="col-lg-5" style="margin-top:78px">
          <div class="add-cart">
            ...
            <div class="mb-3 mt-2">
              <span>{{minPalettesActive.tag}}</span>
            </div>
            <div>
            ...
            <div class="text-center addToCart-sm" id="addToCartsm">
              ...
              <div style="width:75%; height:100px;">
                <button
                  ...
                  style="    line-height: 50px;width:280px;margin:0;"
                >
                  <!-- <span v-if="active_el==1">${{minPalettesActive.S_price}}</span> -->
                  <span v-if="active_el==2" style="font-size:23px">${{minPalettesActive.M_price}}</span>
                  <!-- <span v-if="active_el==3">${{minPalettesActive.L_price}}</span> -->
                ...
                <v-btn
                  ...
                  style="cursor: not-allowed;background-color:#737373;color:#fff;border:none;height:60px !important;width:280px !important;margin:0;padding:0px !important;"
                  v-else
                >{{ $t("message.solidout") }}</v-btn>
                <p
