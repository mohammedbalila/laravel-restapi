<template>
  <nav class="navbar navbar-expand-lg navbar-light px-3 sticky-top" style="direction: ltr;">
    <button
    ...
    <a class="navbar-brand" href="/">
      <img class="logo-ecs" src="images/naqsh.png" width="32px" alt />
    </a>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer modal-cart-footer" v-if="cartItemCount>0">
                  ...
                  >
                    <button type="button" class="btn checkout mb-6" style="font-size: 18px;">
