      ...
      <div class="col-md-5 sm_discount mt-4" style="background-color:#fafafa">
        ...
        >
          <div class="border-bottom p-2 img" v-for="item in cart" :key="item.product.id">
            ...
            <div class="countity" style="float:right">${{item.price}}</div>
            <div style="clear:both"></div>
          ...
          <div style="padding:10px">
            ...
            <span style="float:right;">
              <span style="color:#737171;padding-right: 10px;">
                USD&nbsp; &nbsp;
                <strong style="color:black;font-size:22px">${{totalprice_2}}</strong>
              </span>
            </span>
            <div style="clear:both"></div>
          </div>
      ...
      <div class="col-md-5 lg_discount" style="background-color:#fafafa">
        <div class="discount_section mt-5">
          ...
          <div>
            ...
            <span
              style="float:right;font-size:14px;color:#444f58;padding-right: 10px;"
            >${{discount_value}}</span>
            <div style="clear:both"></div>
          </div>
          <hr />
      ...
      <div class="col-md-7">
        ...
        <v-form class="form" @submit.prevent="send">
          <v-container>
            ...
            <h4 class="text-right">تسجيل البيانات</h4>
            <v-row>
              <v-col cols="12" md="12">
              ...
              <v-row>
                ...
                <v-col cols="12" sm="3">
                  <v-btn
                    @click="apply_discount()"
                    color="#c8c8c8"
                    style="color:white;padding:0 6px"
                  >خصم الأن</v-btn>
                </v-col>
              </v-row>
            </v-form>
